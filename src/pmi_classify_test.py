...
def classify_test(args):
    ...
    models_folder = pathjoin(seq_folder, 'pca_pmi_models')
    os.makedirs(pathjoin(save_folder, 'pca_pmi_preds'),exist_ok=True)
    preds_folder = pathjoin(save_folder, 'pca_pmi_preds')
