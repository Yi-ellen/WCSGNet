...
def get_parser(parser=None):
    ...
    parser.add_argument('-bs', '--batch_size', type=int, default=32)  # Batch size
...
def classify_test(args):
    ...
    pred_save_file = pathjoin(preds_folder, f'wcsn_{base_filename}_a{csn_alpha}_hvgs{HVGs_num}{addname}_prediction.h5')
    ...
    f1_file = pathjoin(preds_folder, f'wcsn_{base_filename}_a{csn_alpha}_hvgs{HVGs_num}{addname}_F1.csv')
    print(f1_all)
